      ...
      <div className="flex gap-1 rounded-xl bg-soft-grey p-1">
        {(
          ...
          <button
            ...
            className={`flex-1 rounded-lg px-1.5 py-1.5 text-xs font-semibold transition-colors ${
              orientation === id
          ...
          {photos.map((photo) => (
            ...
            >
              ...
              >
                ...
                />
                <span className="absolute inset-x-2 bottom-2 rounded-full bg-black/70 px-2 py-1 text-center text-xs font-semibold text-white opacity-0 transition-opacity group-hover:opacity-100 group-focus-visible:opacity-100">
                  {addingId === photo.id ? "Adding…" : "Add photo"}
                </span>
              </button>
              <p className="truncate px-2 py-1.5 text-xs text-grey">
                Photo by{" "}
                <a
          ...
          {filtered.map((item) => (
            ...
            >
              ...
              >
                ...
                <span className="block truncate px-2 py-1.5 text-xs font-semibold text-grey">
                  {item.name}
                </span>
              </button>
              <button
        ...
        <div className="grid grid-cols-2 gap-2">
          {PAPER_TEXTURES.map((item) => (
            ...
            >
              ...
              <span className="block border-t border-black/5 bg-white px-2.5 py-1.5 text-xs font-semibold text-black">
                {item.label}
              </span>
            </button>
          ))}
