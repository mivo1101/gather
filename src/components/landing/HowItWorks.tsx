const steps = [
  {
    ...
    description:
      "Add the date, venue and details once, then manage everything from a dedicated event workspace.",
    icon: (
  ...
  },
  {
    ...
    description:
      "Choose a template or use the canvas editor to build pages with your own type, imagery and interactive blocks.",
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  ...
  {
    number: "03",
    title: "Bring in your guests",
    description:
      "Add guests one by one or import a CSV. Gather creates a private, personalised invitation for each recipient.",
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  ...
  {
    number: "04",
    title: "Send, then stay in the loop",
    description:
      "Compose branded invitation emails, send a test, share unique links and see responses as they arrive.",
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
      ...
      <div className="mx-auto max-w-6xl px-6">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-base text-grey">
            One simple workflow from the first event detail to the final guest
            response.
          </p>
        </div>
